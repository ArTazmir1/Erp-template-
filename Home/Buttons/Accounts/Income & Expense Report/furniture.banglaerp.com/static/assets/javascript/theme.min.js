...
var Theme = function() {
        function t() {
            var e = this;
            _classCallCheck(this, t), this.colors = {
                black: "#14141F",
                brand: {
                    blue: "#0179A8",
                    indigo: "#346CB0",
                ...
                white: "#ffffff"
            }, this.skins = ["default", "dark"], this.skin = localStorage.getItem("skin") || "default", this.autoInit = localStorage.getItem("autoInit") || !0, $(document).ready(function() {
                e.autoInit && e.init()
            })
        }
        ...
        return _createClass(t, [{
            ...
            value: function() {
                $(document).on("focus blur keyup change", ".form-label-group > input", function() {
                    this.classList[this.value ? "remove" : "add"]("placeholder-shown"), setTimeout(function() {}, 2e3)
                ...
                if (this.isIE() || this.isEdge()) {
                    $([".user-avatar img", ".tile > img", ".figure-attachment > img", ".page-cover > .cover-img", ".list-group-item-figure > img"].toString()).each(function() {
                        var e = $(this),
                            t = e.prop("src"),
                            a = e.parent();
                        a.is('[data-toggle="dropdown"]') && (a = a.parent()), t && (a.css({
                            backgroundImage: "url(".concat(t, ")"),
                            backgroundSize: "cover",
                            backgroundPosition: "center center"
                        }), (a.hasClass("user-avatar") || a.hasClass("user-avatar")) && a.css("background-position", "top center"), e.css("opacity", 0))
                    })
                }
            }
        }, {
            ...
            value: function() {
                $(".custom-number").each(function() {
                    ...
                    s.prepend(r).append(l), e.append(s), r.on("click", function() {
            ...
            key: "setSkin",
            value: function(e) {
                e = this.skins.indexOf(e) < 0 ? "default" : e, this.skin !== e && this.invertGrays(), $("body").removeClass("dark-skin default-skin").addClass("".concat(e, "-skin")), localStorage.setItem("skin", e), this.skin = e
            }
        }, {
            key: "invertGrays",
            value: function() {
            ...
            value: function() {
                ...
                $(".app-aside").addClass("show"), $('[data-toggle="aside"]').addClass("active"), t.one("click", function() {
                    e.hideAside()
                })
            }
        }, {
            ...
            value: function() {
                var e;
                window.StackedMenu && this.isExists("#stacked-menu") && (this.asideMenu = new StackedMenu, $(this.asideMenu.selector).on("menu:open menu:close", function() {
                    setTimeout(function() {
                        window.PerfectScrollbar && e.update()
                    }, 300)
                }), window.PerfectScrollbar && (e = new PerfectScrollbar(".aside-menu", {
                    suppressScrollX: !0
                })))
            }
        }, {
            key: "showSidebar",
            value: function(e) {
                $(".has-sidebar").addClass("has-sidebar-open"), $(".page-sidebar").trigger({
                    type: "toggle.sidebar",
                    isOpen: !0,
                    relatedTarget: e
                })
            ...
            key: "hideSidebar",
            value: function(e) {
                $(".has-sidebar").removeClass("has-sidebar-open"), $(".page-sidebar").trigger({
                    type: "toggle.sidebar",
                    isOpen: !1,
                    relatedTarget: e
                })
            ...
            value: function() {
                var t = this;
                this.sidebarBackdrop(), $(document).on("click", '[data-toggle="sidebar"], .sidebar-backdrop', function(e) {
            ...
            value: function() {
                $(document).on("click", '[data-toggle="radiolist"] > *', function() {
                    var e = $(this).parent();
                    e.children().removeClass("active"), $(this).addClass("active"), e.trigger({
                        type: "change",
                        relatedTarget: this
                    })
                })
            ...
            value: function() {
                $(document).on("click", '[data-toggle="checkboxlist"] > *', function() {
                    ...
                    $(this).toggleClass("active", !t), e.trigger({
                        type: "change",
                        relatedTarget: e.children(".active")
                    })
                })
            }
        }, {
            ...
            value: function() {
                window.PerfectScrollbar && this.isExists(".perfect-scrollbar") && $('.perfect-scrollbar:not(".aside-menu")').each(function() {
            ...
            key: "masonry",
            value: function() {
                window.Masonry && $(document).ready(function() {
                    ...
                    var e = this.colors,
                        ...
                        i = {
                            global: {
                                ...
                                defaultColor: t ? this.hexToRgba(e.white, .08) : this.hexToRgba(e.black, .1),
                                ...
                                tooltips: {
                                    backgroundColor: t ? this.hexToRgba(e.white, .98) : this.hexToRgba(e.black, .98),
                                    xPadding: 8,
                                    yPadding: 8,
                                    titleMarginBottom: 8,
                                    footerMarginTop: 8,
                            ...
                            scale: {
                                gridLines: {
                                    color: t ? this.hexToRgba(e.white, .08) : this.hexToRgba(e.black, .1),
                                    zeroLineColor: t ? this.hexToRgba(e.white, .08) : this.hexToRgba(e.black, .1)
                                }
                            }
                        };
            ...
            value: function() {
                ...
                return {
                    xaxis: {
                        tickColor: t ? this.hexToRgba(e.white, .08) : this.hexToRgba(e.black, .1),
                        color: t ? a[400] : a[600]
                    },
                    yaxis: {
                        tickColor: t ? this.hexToRgba(e.white, .08) : this.hexToRgba(e.black, .1),
            ...
            key: "sparkline",
            value: function() {
                $.fn.sparkline && $('[data-toggle="sparkline"]').each(function() {
                    var e = $(this).data(),
                        t = e.values || "html";
                    $(this).sparkline(t, e)
                })
            ...
            value: function() {
                if ($.fn.easyPieChart) {
                    ...
                    $('[data-toggle="easypiechart"]').each(function() {
                        var e = $(this).data();
                        e.barColor = e.barColor || t.colors.brand.teal, e.trackColor = e.trackColor || "dark" === t.skin ? t.getColors("gray")[200] : t.colors.white, e.scaleColor = e.scaleColor || "transparent", e.lineWidth = e.lineWidth ? parseInt(e.lineWidth) : 8, e.size = e.size ? parseInt(e.size) : 120, e.rotate = e.rotate ? parseInt(e.rotate) : 0, e.trackColor = "false" != e.trackColor && "" != e.trackColor && e.trackColor, e.scaleColor = "false" != e.scaleColor && "" != e.scaleColor && e.scaleColor, $(this).easyPieChart(e)
                    })
                }
            }
        }, {
            ...
            value: function() {
                if ($.fn.knob) {
                    ...
                    $('[data-toggle="knob"]').each(function() {
                        var e = $(this).data();
                        e.bgColor = e.bgcolor || t.getLightColor(), e.fgColor = e.fgcolor || t.colors.brand.teal, e.draw = function() {
            ...
            key: "sortable",
            value: function() {
                window.Sortable && $('[data-toggle="sortable"]').each(function() {
                    var e = $(this).data();
            ...
            key: "nestable",
            value: function() {
                $.fn.nestable && $('[data-toggle="nestable"]').each(function() {
                    var e = $(this).data();
                    $(this).nestable(e)
                })
            }
            ...
            key: "plyr",
            value: function() {
                window.Plyr && $('[data-toggle="plyr"]').each(function() {
                    new Plyr(this)
                })
            }
        }, {
            ...
            key: "bootstrapSelect",
            value: function() {
                $.fn.selectpicker && ($.fn.selectpicker.Constructor.DEFAULTS.style = "", $.fn.selectpicker.Constructor.DEFAULTS.styleBase = "custom-select", $.fn.selectpicker.Constructor.DEFAULTS.iconBase = "fa", $.fn.selectpicker.Constructor.DEFAULTS.tickIcon = "fa-check font-size-sm mt-2", $('[data-toggle="selectpicker"]').each(function() {
                    $(this).selectpicker().on("loaded.bs.select", function(e) {
            ...
            key: "select2",
            value: function() {
                $.fn.select2 && ($.fn.select2.defaults.set("width", "100%"), $('[data-toggle="select2"]').each(function() {
                    var e = $(this).data();
                    e = e.options ? e.options : e, $(this).select2(e)
                }))
            }
        }, {
            key: "atwho",
            value: function() {
                $.fn.atwho && $('[data-toggle="atwho"]').each(function() {
                    var e = $(this).data();
                    $(this).atwho(e)
                })
            }
            ...
            key: "tribute",
            value: function() {
                window.Tribute && $('[data-toggle="tribute"]').each(function() {
                    var t = $(this).data();
                    t.menuContainer = document.querySelector(t.menuContainer) || !1, 1 == t.itemTemplate && (t.menuItemTemplate = function(e) {
                        return '<span class="user-avatar user-avatar-sm mr-2"><img src="'.concat(e.original.avatar, '"></span> ').concat(e.string)
                    }), 1 == t.selectTemplate && (t.selectTemplate = function(e) {
            ...
            key: "flatpickr",
            value: (i = function() {
                window.flatpickr && (flatpickr.defaultConfig.disableMobile = !0, $('[data-toggle="flatpickr"]').each(function() {
                    var e = $(this).data();
                    e.plugins = [], e.disable = e.disables || [], e.defaultDate = e.defaultDates || null, e.confirmdate && e.plugins.push(new confirmDatePlugin({
                        showAlways: !0
                    })), e.weekselect && e.plugins.push(new weekSelect({})), e.monthselect && e.plugins.push(new monthSelectPlugin({
                        shorthand: !0,
                        dateFormat: "m/y",
                        altFormat: "F Y"
                    })), e.rangeplugin && e.plugins.push(new range({
                        input: "#".concat(e.secondInput)
                    })), flatpickr(this, e)
                }))
            }, o.toString = function() {
                return i.toString()
            ...
            key: "colorpicker",
            value: function() {
                $.fn.colorpicker && $('[data-toggle="colorpicker"]').each(function() {
                    var e = $(this).data();
                    $(this).colorpicker(e)
                })
            }
            ...
            key: "touchspin",
            value: function() {
                $.fn.TouchSpin && $('[data-toggle="touchspin"]').each(function() {
                    var e = $(this).data(),
                        t = {
            ...
            key: "nouislider",
            value: function() {
                window.noUiSlider && $('[data-toggle="nouislider"]').each(function() {
                    var e = $(this).data();
            ...
            key: "summernote",
            value: function() {
                $.fn.summernote && $('[data-toggle="summernote"]').each(function() {
                    var e = $(this).data();
                    e.callbacks = {
                        onInit: function(e) {
            ...
            key: "quill",
            value: function() {
                window.Quill && $('[data-toggle="quill"]').each(function() {
                    var e = $(this).data();
                    null == e.modules && (e.modules = {
                        formula: !0,
                        syntax: !0,
                        toolbar: [
                            [{
                    ...
                    }), e.theme = e.theme ? e.theme : "snow", new Quill(this, e)
                })
            }
        }, {
            key: "simplemde",
            value: function() {
                window.SimpleMDE && $('[data-toggle="simplemde"]').each(function() {
                    var e = $(this).data();
            ...
            key: "maskInput",
            value: function() {
                window.vanillaTextMask && $("[data-mask]").each(function() {
                    var e = $(this).data(),
                        t = e.mask;
                    if (e.inputElement = this, e.mask = {
                            ...
                            expdatecc: [/\d/, /\d/, "/", /\d/, /\d/],
                            cvc: [/\d/, /\d/, /\d/]
                        }[e.mask] || [], e.placeholderChar = e.placeholderChar || "#", "cazip" == t ? e.pipe = function(e) {
                            return e.toUpperCase()
                        } : "email" == t ? e.mask = textMaskAddons.emailMask || [] : "currency" == t ? (e.prefix = e.prefix || "", e.mask = textMaskAddons.createNumberMask ? textMaskAddons.createNumberMask(e) : []) : "percentage" == t && (e.prefix = "", e.suffix = "%", e.mask = textMaskAddons.createNumberMask ? textMaskAddons.createNumberMask(e) : []), e.autoCorrectDate) {
                        var a = textMaskAddons.createAutoCorrectedDatePipe ? textMaskAddons.createAutoCorrectedDatePipe(e.autoCorrectDate) : null;
                        e.pipe = a
                    }
                    vanillaTextMask.maskInput(e)
                })
            }
        }, {
            key: "headroom",
            value: function() {
                window.Headroom && $('[data-toggle="headroom"]').each(function() {
                    var e = $(this).data();
            ...
            key: "zxcvbn",
            value: (a = function() {
                window.zxcvbn && $(".form-strength-meter").each(function() {
                    var i = this,
                    ...
                    $(i).on("keyup", function() {
                        ...
                        "" !== e ? ($(o).removeClass("d-none ".concat(s.join(" "))).addClass("".concat(s[t.score])).css("width", a), $(n).html("<strong>".concat(t.feedback.warning, "</strong> ").concat(t.feedback.suggestions))) : ($(o).addClass("d-none"), $(n).html(""))
                    })
                })
            }, e.toString = function() {
                return a.toString()
            ...
            value: function() {
                ...
                $(window).on("resize", function() {
                    e.isToggleScreenUp() && $(".app-aside").hasClass("has-open") && !$(".app").hasClass("has-fullwidth") && e.closeAside(), $(".app-aside, .page-sidebar").addClass("notransition"), setTimeout(function() {
            ...
            key: "watchIE",
            value: function() {
                this.isIE() && $(".metric").each(function() {
                    var e = $(this).height();
            ...
            key: "isOpera",
            value: function() {
                return !!window.opr && !!opr.addons || !!window.opera || 0 <= navigator.userAgent.indexOf("OPR/index.html")
            }
        }, {
            key: "isFirefox",
            value: function() {
            ...
            key: "browserFlagging",
            value: function() {
                this.isOpera() && $("body").addClass("opera"), this.isFirefox() && $("body").addClass("firefox"), this.isSafari() && $("body").addClass("safari"), this.isIE() && $("body").addClass("ie"), this.isEdge() && $("body").addClass("edge"), this.isChrome() && $("body").addClass("chrome"), this.isBlink() && $("body").addClass("blink")
            }
        }, {
            key: "osFlagging",
            value: function() {
    ...
    Looper = function() {
        var a = new Theme;
        return $('[data-toggle="skin"]').on("click", function(e) {
            e.preventDefault();
